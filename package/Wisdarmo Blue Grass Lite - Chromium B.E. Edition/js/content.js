...
const suInnerHTML1 = ` 
	<div>
		<center>
			<br><br>
			<img src="`+ chrome.runtime.getURL('img/OttoThumbDown.png') +`" width="200"/>
			<div>
			...
			<img src="`+ chrome.runtime.getURL('img/In-Case-Of-Emergency-Turn-Off-The-Internet-Social-Media-Logo2.png') +`" width="300"/>
		</center>
	</div>
`
	...
	<div class="column" id="pageerror">
		<div class="pod">
			...
			<div class="pod-body">
				...
				<center><img src="`+ chrome.runtime.getURL('img/In-Case-Of-Emergency-Turn-Off-The-Internet-Social-Media-Logo2.png') +`" width="300"/></center>
			</div>
		</div>
	</div>
`
...
const rm_innerhtml1 = `
	<div class="container">
		...
		<br>
		<br>
		<img src="` + chrome.runtime.getURL('img/In-Case-Of-Emergency-Turn-Off-The-Internet-Social-Media-Logo2.png') + `" width="200"/>
	</div>
`

const rm_innerhtml2 =`
	<title>Restricted access</title>
	<link rel="stylesheet" href="` + chrome.runtime.getURL('css/common.css') +`">
	<link rel="stylesheet" href="` + chrome.runtime.getURL('css/restrictedpagestyle.css') +`">
`
